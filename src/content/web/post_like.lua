...
'browser_vendor', '%s',
'os', '%s',
'os_version', '%s']], client_ip, db.quote(util.query_ip(client_ip).address), ngx.today(), ngx.time(), db.quote(ngx.var.http_user_agent), ua.name, ua.category, ua.version, ua.vendor, ua.os, ua.os_version)
